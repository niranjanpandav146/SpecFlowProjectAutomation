...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "ShoppingCart", "Shopping Cart Feature", ProgrammingLanguage.CSharp, featureTags);
        ...
        public void ConsumerCanAddABookToShoppingCartFromWishList(string userName, string password, string firstName, string lastName, string postalCode, string productName, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Consumer can add a book to shopping cart from wish list", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 6
